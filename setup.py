...
Generates interactive Plotly charts and PDF/HTML reports
Run: python scripts/generate_report_animated.py
...
try:
    ...
    print("⚠️ WeasyPrint not installed. PDF export disabled. Install with: pip install weasyprint")
...
class AnimatedReportGenerator:
    ...
    def __init__(self):
        ...
        self.plots_path = self.project_root / 'visualizations/reports/plots'
        self.reports_path = self.project_root / 'visualizations/reports'
        self.html_path = self.reports_path / 'html'
    ...
    def create_model_comparison_chart(self) -> go.Figure:
        ...
        # RMSE Bar Chart
        colors_rmse = [self.colors['success'] if m == 'CatBoost' else 
                       self.colors['warning'] if m == 'Ensemble' else 
                       self.colors['primary'] for m in models]
        ...
        colors_dir = [self.colors['success'] if d > 41 else self.colors['primary'] for d in direction_acc]
    ...
    def create_ensemble_weights_chart(self) -> go.Figure:
        ...
        colors = [self.colors['success'], self.colors['primary'], self.colors['warning'],
                  self.colors['secondary'], self.colors['purple'], self.colors['info']]
    ...
    def save_charts(self) -> Dict[str, Path]:
        ...
        for name, fig in charts.items():
            ...
            # Save as PNG
            png_path = self.plots_path / f'{name}.png'
            try:
                fig.write_image(str(png_path), width=1200, height=600, scale=2)
                saved_paths[f'{name}_png'] = png_path
    ...
    def generate_html_report(self, chart_paths: Dict[str, Path]) -> Path:
...
<body>
        ...
        <div class="content">
            ...
            <div class="section">
                ...
                <div class="chart-container">
                    <iframe src="html/model_comparison.html" style="width:100%; height:500px; border:none;"></iframe>
                </div>
            </div>
            ...
            <div class="section">
                ...
                <div class="chart-container">
                    <iframe src="html/ensemble_weights.html" style="width:100%; height:500px; border:none;"></iframe>
                </div>
            </div>
            ...
            <div class="section">
                ...
                <div class="chart-container">
                    <iframe src="html/feature_importance.html" style="width:100%; height:500px; border:none;"></iframe>
                </div>
            </div>
            ...
            <div class="section">
                ...
                <div class="chart-container">
                    <iframe src="html/equity_curve.html" style="width:100%; height:500px; border:none;"></iframe>
                </div>
                <div class="chart-container">
                    <iframe src="html/drawdown.html" style="width:100%; height:500px; border:none;"></iframe>
                </div>
            </div>
            ...
            <div class="section">
                ...
                <div class="chart-container">
                    <iframe src="html/financial_metrics.html" style="width:100%; height:500px; border:none;"></iframe>
                </div>
            </div>
        </div>
    ...
    def generate_pdf_report(self, html_path: Path) -> Optional[Path]:
        """Convert HTML to PDF using WeasyPrint"""
        if not WEASYPRINT_AVAILABLE:
            print("⚠️ PDF generation skipped (WeasyPrint not installed)")
            return None
    ...
    def run(self):
        ...
        for name in ['model_comparison', 'ensemble_weights', 'feature_importance', 'equity_curve', 'drawdown', 'financial_metrics']:
            print(f"      - {name}.html")
...
if __name__ == "__main__":
    ...
    import webbrowser
    webbrowser.open(str(results['html_report']))